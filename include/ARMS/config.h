...
#define LEFT_MOTORS -13, -14, -16
#define RIGHT_MOTORS 15, 17, 18
#define GEARSET pros::E_MOTOR_GEAR_600  // RPM of chassis motors

// Ticks per inch
#define TPI \
    360 / (3.25 * M_PI)  // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI 1     // Ticks per inch for the middle wheel

// Tracking wheel distances
#define TRACK_WIDTH \
    9.5  // The distance between left and right wheels (or tracker wheels)
...
#define AUTONS                                        \
    "Near Qual", "Far Qual", "Near Elim", "Far Elim", \
        "Do Nothing"  // Names of autonomi, up to 10
